...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--cache-dir",
        required=True,
        help="Training cache dir containing cnn_* transformers/npz",
    )
    p.add_argument(
        "--output-dir",
...
def main() -> None:
    ...
    param_tf_path = cache_dir / "cnn_param_transformer.joblib"
    scalar_tf_path = cache_dir / "cnn_scalar_transformer.joblib"
    physics_tf_path = cache_dir / "cnn_physics_transformer.joblib"
    pre_npz_path = cache_dir / "cnn_preprocessed.npz"

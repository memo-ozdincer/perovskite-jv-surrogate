...
For this part, just compare it to the other papers in literature in a table and talk about it.
...
The model is implemented in PyTorch (\texttt{train\_attention\_tcn.py}) and operates directly on 8-point PCHIP voltage slices centered around the MPP region.
...
Talk about it as an experiment that proved to reduce performance.
